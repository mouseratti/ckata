...
// - relational operators as free functions - taking const char* as one of the params
    ...
    struct ContextOptions //!OCLINT too many fields
    {
        ...
        bool success;              // doctest successful assertions in output
...
// =================================================================================================
// The following code has been taken verbatim from Catch2/doctest/internal/catch_xmlwriter.h/cpp
    ...
    struct ConsoleReporter : public IReporter
    {
        ...
        void printHelp() {
            ...
            s << " -" DOCTEST_OPTIONS_PREFIX_DISPLAY "s,   --" DOCTEST_OPTIONS_PREFIX_DISPLAY "success=<bool>                "
              << Whitespace(sizePrefixDisplay*1) << "doctest successful assertions in output\n";
